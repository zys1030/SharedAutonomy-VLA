...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "state[7] is live ee.z_m; state[8]=Δee_z; state[9]=time_since_close. "
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Escape hatch when /health has no state_names: use the first N live catalog channels.",
    )
...
if __name__ == "__main__":
    try:
        ...
        logger.exception("observe_only_infer failed")
        sys.exit(1)
