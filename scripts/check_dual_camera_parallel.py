...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--external-opencv-index", type=int, default=3)
...
def main() -> None:
    ...
    result: dict[str, Any] = {
        ...
        "devices": {
            ...
            "realsense_serial": profile.get_device().get_info(rs.camera_info.serial_number),
            "realsense_usb_type": profile.get_device().get_info(rs.camera_info.usb_type_descriptor),
            "external_opencv_index": args.external_opencv_index,
            "external_model_guess": "Logitech HD Pro Webcam C920",
        },
        "notes": {
            "scope": (
