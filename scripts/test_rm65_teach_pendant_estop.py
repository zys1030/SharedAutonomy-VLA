...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Move only joint 6 at low speed while an operator triggers the teach-pendant "
            "emergency stop. This is not a substitute for testing an independent physical E-stop."
        )
    )
