"""Build a grasp-critical frame index from a LeRobot dataset.

This command reads only the raw LeRobot ``action`` column.  It does not
decode images, connect to hardware, or modify the dataset.
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Build first-grasp critical windows from raw LeRobot actions."
    )
