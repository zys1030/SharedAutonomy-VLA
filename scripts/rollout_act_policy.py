...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--duration-s", type=float, default=40.0, help="Rollout duration in seconds (default 40)")
    ...
    parser.add_argument("--ready-config", default=None, help="Optional ready_pose YAML override")
...
def main() -> int:
    ...
    if args.enable_gripper:
        ...
        gripper_handler = ThresholdGripperActuator(teleop=gripper_actuator)
    ...
    try:
        ...
        for step_index in range(total_steps):
            ...
            if step_result.gripper_commanded:
                commanded_gripper_fraction = step_result.gripper_open_fraction
