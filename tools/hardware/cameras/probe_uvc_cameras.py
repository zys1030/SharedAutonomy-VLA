...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--friendly-name",
        default=None,
        help="Substring match against DirectShow friendly name",
    )
    parser.add_argument("--vendor-id", default=None, help="Four-digit USB vendor ID")
    parser.add_argument("--product-id", default=None, help="Four-digit USB product ID")
